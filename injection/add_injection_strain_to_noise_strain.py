...
###############
# python add_injection_strain_to_noise_strain.py --strain-channel V1:Hrec_hoft_raw_20000Hz --chanslist  /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/Multi-train-process/First-run/witnesses/witnesses_142-162_Hz.ini  --noise-frame /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/Multi-train-process/First-run/4096/layer0/Hrec-HOFT-1265127585-100000/original-1265127585-4096.h5  --inj-frame /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/Injections/15-415_Hz/GWsignals/V1_BBH_inj_1265127585_4096.hdf5 --output-frame /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/Injections/15-415_Hz/StainGWsignals
#####################


# python add_injection_strain_to_noise_strain.py --strain-channel V1:Hrec_hoft_raw_20000Hz --chanslist  /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/Injections/witnesses/witnesses_142-162_Hz.ini  --noise-frame /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/142-162_Hz/4096/Hrec-HOFT-1265127585-50000/original-1265127585-4096.h5   --inj-frame /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/Injections/142-162_5_Mpc/V1_BBH_inj_1265127585_4096.hdf5 --output-frame /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/Injections/142-162_5_Mpc/ORG_NoisePlusSignal

# python add_injection_strain_to_noise_strain.py --strain-channel V1:Hrec_hoft_raw_20000Hz --chanslist /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/Multi-train-process/First-run/witnesses/witnesses_142-162_Hz.ini  --noise-frame /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/Multi-train-process/First-run/4096/layer0/original-1265127585-4096.h5  --inj-frame /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/Injections/new_injection/CNR-version/special/rework_15_415_Hz/injSignal/V1_BBH_inj_1265127585_4096.hdf5 --output-frame ./rework_15_415_Hz/noisePlusSignal/layer0
...
parser.add_argument(
    "--inj-frame", type=str, help="Path to the injection strain frame file"
)
parser.add_argument(
    "--output-frame", type=str, help="Path to the noise+signal frame file"
)
parser.add_argument(
    "--chanslist",
    type=str,
    help="Path to the chanslist that lists the channels in --noise-frame",
)
...
injected_file = os.path.join(args.output_frame, f"{(args.noise_frame).split('/')[-1]}")
print(injected_file)
