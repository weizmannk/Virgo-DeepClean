...
output = "142-162_Hz/matchedfilter_SNR_Freq"
...
# Parametters
time_pairs = [
    (1265127585, 1265172641),
    (1265176737, 1265225889),
    (1265227585, 1265272641),
    (1265276737, 1265325889),
    ...
    while start_time + duration <= end_time:
        ...
        wrapper_content = textwrap.dedent(
            ...
            python matched_filter_snr_freq.py --inj-gap 32 \\
                ...
                --injections-file /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/Injections/new_injection/CNR-version/special/Rework/142-162_Hz/injSignal/INJ-{start_time}-{duration}.csv \\
                --inj-gw-signal /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/Injections/new_injection/CNR-version/special/Rework/142-162_Hz/injSignal/V1_BBH_inj_{start_time}_{duration}.hdf5 \\
                --org-noise /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/142-162_Hz/4096/Hrec-HOFT-{initial_time}-50000/original-{start_time}-{duration}.h5 \\
                --org-noise-gw-signal /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/Injections/new_injection/CNR-version/special/Rework/142-162_Hz/noisePlusSignal/original-{start_time}-{duration}.h5 \\
                --cleaned-noise /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/142-162_Hz/4096/Hrec-HOFT-{initial_time}-50000/Hrec-HOFT-{start_time}-{duration}.gwf \\
                --cleaned-gw-signal /home/weizmann.kiendrebeogo/DeepClean/DeepClean_CIT/Injections/new_injection/CNR-version/special/Rework/142-162_Hz/noisePlusSignal/Hrec-HOFT-{start_time}-{duration}.gwf \\
                --fmin 142 --fmax 162 \\
